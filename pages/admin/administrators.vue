        ...
        <div class="column is-one-third">
          <form @submit.prevent="createAdmin">
            ...
            <div class="field">
              ...
              <div class="control">
                  <input class="input" type="email" name="email" v-model="email" v-validate="'required|email'" :class="{ 'is-danger': errors.has('email') }">
          ...
          <table class="table is-striped is-fullwidth">
            ...
            <tbody>
              <tr v-for="(admin, index) in admins" :key="admin.id">
                  <th>{{ ++index }}</th>
                  <td>{{ admin.name }}</td>
                  <td><a href="#" @click.prevent="removeAdmin(admin)"><span class="icon has-text-danger"><i class="fa fa-lg fa-times-circle"></i></span></a></td>
              </tr>              
            </tbody>
          </table>
        </div>                
