        ...
        <div class="columns">
          ...
          <div class="column">
            ...
            <div class="field">
              ...
              <div class="control">
                <input class="input" type="text" name="code" v-model="code" v-validate="'required|min:2'" :class="{ 'is-danger': errors.has('code') }">
            ...
            <div class="field">
              ...
              <div class="control">
                <input class="input" type="text" name="brand" v-model="brand" v-validate="'required|min:2'" :class="{ 'is-danger': errors.has('brand') }">
            ...
            <div class="field">
              ...
              <div class="control">
                <input class="input" type="text" name="price" v-model="price" v-validate="'required|decimal:2'" :class="{ 'is-danger': errors.has('price') }">
            ...
            <div class="field">
              ...
              <div class="control">
                <input class="input" type="number" name="stock" v-model="stock" v-validate="'required|numeric'" :class="{ 'is-danger': errors.has('stock') }">
            ...
            <!-- <div class="field">
              ...
              <div class="control">
                <div class="select is-multiple">
                  <select multiple size="3" name="belongs" v-model="belongs" v-validate="'required'" :class="{ 'is-danger': errors.has('belongs') }">                  
                    <option v-for="category in categories" :key="category.key" :value="category.key">{{ category.name }}</option>
                  </select>                
                </div>
                <p v-show="errors.has('belongs')" class="help is-danger">{{ errors.first('belongs') }}</p>
              </div>
            </div>  -->
            <div class="field">
            ...
            <div class="field">
              <div class="control">
                <button class="button is-primary" :class="{ 'is-loading': busy }" :disabled="busy">{{ !key ? 'Add' : 'Update' }}</button>
              </div>                    
            </div>
          </div>                
        </div>  
